...
class LangModeler(object):
    def __init__(self, languages, words):
        self.languages = languages  # Liste mit Sprachen
        self.words = words  # dictionary mit (lang: [words])
    ...
    def build_language_models(self):
        ...
        return nltk.ConditionalFreqDist([(lang, word.lower()) for lang in self.languages for word in self.words[lang]])  # cfd mit lang als conditions
